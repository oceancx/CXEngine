...
local TITLE = "Chapter 5 - Multiple textures"
local W, H = 800, 600
...
local prog, vsh, fsh = gl.make_program('vertex', "shaders/multitex.vert", 'fragment', "shaders/multitex.frag")
