...
local TITLE = "Chapter 3 - Two-sided lighting"
local W, H = 800, 600
...
local vertex_shader = "shaders/twoside.vert"
local fragment_shader = "shaders/twoside.frag"
-- local vertex_shader = "shaders/twoside_conditional.vert"
-- local fragment_shader = "shaders/twoside_conditional.frag"
...
local view = glmath.look_at(vec3(2,4,2), vec3(0,0,0), vec3(0,1,0))
...
-- Generate the mesh
local teapot = new_teapot(13, glmath.translate(0, 1.5, .25))

-- Event loop -----------------------------------------------------------------

gl.enable('depth test')
gl.clear_color(0.5, 0.5, 0.5, 1.0)
-- gl.front_face('cw') -- uncomment to change winding (default is 'ccw')
