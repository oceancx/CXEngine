...
local TITLE = "Chapter 3 - Example of discarding fragments"
local W, H = 500, 500
...
local vertex_shader = "shaders/discard.vert"
local fragment_shader = "shaders/discard.frag"
...
local view = glmath.look_at(vec3(0.0,0.0,7.0), vec3(0.0,0.0,0.0), vec3(0.0,1.0,0.0))
...
while not glfw.window_should_close(window) do
   ...
   local light_pos = vec4(0.0,0.0,0.0,1.0)
   gl.uniformf(loc["Light.Position"], light_pos)

   local model = glmath.translate(0, -1.5, 0)*
