...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/4.1.lighting_maps.vert",
                                         fragment="shaders/4.1.lighting_maps.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="shaders/4.1.lamp.vert",
                                         fragment="shaders/4.1.lamp.frag"})
gl.delete_shaders(vsh, fsh)
...
while not glfw.window_should_close(window) do
   ...
   gl.uniformf(loc1["material.specular"], 0.5, 0.5, 0.5)
