...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/2.1.basic_lighting.vert",
                                         fragment="shaders/2.1.basic_lighting.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="shaders/2.1.lamp.vert",
                                         fragment="shaders/2.1.lamp.frag"})
gl.delete_shaders(vsh, fsh)
