...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/3.2.materials.vert",
...
while not glfw.window_should_close(window) do
   ...
   gl.uniformf(loc1["light.diffuse"],  1.0, 1.0, 1.0) -- full intensity
   gl.uniformf(loc1["light.ambient"],  1.0, 1.0, 1.0) -- full intensity
   gl.uniformf(loc1["light.specular"], 1.0, 1.0, 1.0)
   -- material properties
   gl.uniformf(loc1["material.ambient"], 0.0, 0.1, 0.06)
   gl.uniformf(loc1["material.diffuse"], 0.0, 0.50980392, 0.50980392)
   gl.uniformf(loc1["material.specular"], 0.50196078, 0.50196078, 0.50196078)
