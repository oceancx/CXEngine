...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/5.3.light_casters.vert",
                                         fragment="shaders/5.3.light_casters.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="shaders/5.3.lamp.vert",
                                         fragment="shaders/5.3.lamp.frag"})
gl.delete_shaders(vsh, fsh)
