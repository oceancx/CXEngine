...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/5.2.light_casters.vert",
                                         fragment="shaders/5.2.light_casters.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="shaders/5.2.lamp.vert",
                                         fragment="shaders/5.2.lamp.frag"})
gl.delete_shaders(vsh, fsh)
