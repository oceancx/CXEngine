...
local prog1, vsh, fsh = gl.make_program({vertex="shaders/4.2.lighting_maps.vert",
                                         fragment="shaders/4.2.lighting_maps.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="shaders/4.2.lamp.vert",
                                         fragment="shaders/4.2.lamp.frag"})
gl.delete_shaders(vsh, fsh)
