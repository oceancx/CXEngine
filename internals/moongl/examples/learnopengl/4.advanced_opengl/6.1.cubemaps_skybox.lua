...
local prog, vsh, fsh = gl.make_program({vertex="shaders/6.1.cubemaps.vert",
                                         fragment="shaders/6.1.cubemaps.frag"})
gl.delete_shaders(vsh, fsh)
local prog1, vsh, fsh = gl.make_program({vertex="shaders/6.1.skybox.vert",
                                         fragment="shaders/6.1.skybox.frag"})
gl.delete_shaders(vsh, fsh)
