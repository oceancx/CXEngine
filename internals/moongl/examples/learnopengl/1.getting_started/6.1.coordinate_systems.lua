...
local prog, vsh, fsh = gl.make_program({vertex="shaders/6.1.coordinate_systems.vert",
                                         fragment="shaders/6.1.coordinate_systems.frag"})
...
while not glfw.window_should_close(window) do
   ...
   local model = glmath.rotate(math.rad(-55), 1.0, 0.0, 0.0)
